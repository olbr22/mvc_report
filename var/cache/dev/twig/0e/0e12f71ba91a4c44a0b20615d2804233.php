    ...
    <div class=\"container my-5\">
        ...
        echo "\" class=\"list-group-item list-group-item-action\" aria-current=\"true\">
            ...
            <div class=\"col-sm-8\">
                <p>Antal kort: ";
        // line 34
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["deck"]) || array_key_exists("deck", $context) ? $context["deck"] : (function () { throw new RuntimeError('Variable "deck" does not exist.', 34, $this->source); })()), "getNumCards", [], "any", false, false, false, 34), "html", null, true);
        echo "</p>
                ";
        // line 35
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["deck"]) || array_key_exists("deck", $context) ? $context["deck"] : (function () { throw new RuntimeError('Variable "deck" does not exist.', 35, $this->source); })()), "getDeck", [], "method", false, false, false, 35));
...
{% block body %}
    ...
    <div class=\"container my-5\">
        ...
        <div class=\"row my-5\">
            ...
            <div class=\"col-sm-8\">
                <p>Antal kort: {{ attribute(deck, 'getNumCards') }}</p>
...
{% endblock %}", "card/deck.html.twig", "/home/olga/dbwebb-kurser/mvc/me/report/templates/card/deck.html.twig");
    }
}
