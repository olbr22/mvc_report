...
class __TwigTemplate_a93f3d053a72987ed4d0c33aff41d69f extends Template
{
    private $source;
    private $macros = [];
...
<style>
    ...
    <ul>
        <li><a href=\"{{ path('book_create_get') }}\">Create a new book</a></li>
        <li><a href=\"{{ path('book_show_all') }}\">Show all the books</a></li>
    </ul>
{% endblock %}
", "library/index.html.twig", "/home/olga/dbwebb-kurser/mvc/me/report/templates/library/index.html.twig");
    }
}
