...
<div class=\"example-wrapper\">
    <h1>Edit \" ";
        // line 12
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["book"]) || array_key_exists("book", $context) ? $context["book"] : (function () { throw new RuntimeError('Variable "book" does not exist.', 12, $this->source); })()), "title", [], "any", false, false, false, 12), "html", null, true);
        echo " \"</h1>
    <a href=\"";
        // line 13
    ...
    <form action=\"";
        // line 14
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("book_update_post", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["book"]) || array_key_exists("book", $context) ? $context["book"] : (function () { throw new RuntimeError('Variable "book" does not exist.', 14, $this->source); })()), "id", [], "any", false, false, false, 14)]), "html", null, true);
        echo "\" method=\"post\">
        ...
        // line 20
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["book"]) || array_key_exists("book", $context) ? $context["book"] : (function () { throw new RuntimeError('Variable "book" does not exist.', 20, $this->source); })()), "isbn", [], "any", false, false, false, 20), "html", null, true);
...
";
    ...
    {
        return array (  124 => 22,  119 => 20,  114 => 18,  109 => 16,  104 => 14,  100 => 13,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"example-wrapper\">
    ...
    <form action=\"{{ path('book_update_post', {'id': book.id}) }}\" method=\"post\">
        <label for=\"title\">Title:</label>
        <input type=\"text\" id=\"title\" name=\"title\" value = \"{{ book.title }}\"><br>
        <label for=\"author\">Author:</label>
        <input type=\"text\" id=\"author\" name=\"author\" value = \"{{ book.author }}\"><br>
        <label for=\"isbn\">ISBN:</label>
        <input type=\"text\" id=\"isbn\" name=\"isbn\" value = \"{{ book.isbn }}\" maxlength=\"13\"><br>
        <label for=\"image\">Image:</label>
        <input type=\"text\" id=\"image\" name=\"image\" value = \"{{ book.image }}\"><br>
        <input type=\"submit\" value=\"Submit\">
    </form>
</div>
{% endblock %}
", "book/update.html.twig", "/home/olga/dbwebb-kurser/mvc/me/report/templates/book/update.html.twig");
    }
}
